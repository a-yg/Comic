...
export default defineComponent({
  ...
  setup() {
    ...
    const searchItem = () => {
      searchWord.value = data.value.filter((item) => {
        return item.title.includes(route.value.query['searchWord'])
      })
      resNumber.value = searchWord.value.length
    }
